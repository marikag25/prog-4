...
int main() {
    ...
    if (vertices.size() >= 4) {
        Kvadrat square(vertices[0], vertices[1], vertices[2], vertices[3]);

        cout << "Pocetno" << square.t1.x << ", " << square.t1.y << endl;

        pomestiDesno(square);
        cout << "Translacija" << square.t1.x << endl;

        rotiraj45(square);
        cout << "Rotacija " << square.t1.x << ", " << square.t1.y << endl;

        homotetija(square);
        cout << "Homotetija " << square.t1.x << ", " << square.t1.y << endl;
    } else {
        cout << "Greska" << endl;
    }
